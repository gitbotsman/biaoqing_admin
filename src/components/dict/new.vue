      ...
      <div class="card mb-3 p-3 b-0">
        ...
        <div class="row">
          <label class="form-group col-lg-7" v-styling="'code'">字典编码
            <input name="code" v-model="code" title="字典编码" v-validate="'required|min:2|max:32|remote:dict/code-validation'" class="form-control" placeholder="字典编码">
            <span class="form-control-feedback">{{ errors.first('code') }}</span>
          </label>
        </div>
        <label class="form-group">字典描述<input name="description" v-model="description" class="form-control" placeholder="描述" maxlength="256"></label>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      remove (index) { this.dicts.splice(index, 1) },
      submit () {
